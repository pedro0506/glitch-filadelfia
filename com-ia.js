        ...
        if (!handledMessages[message.id]) {
          ...
          if (timeDifference < 300000) {
            ...
            if (message.type === "text") {
              if (
                (message.text.body && message.text.body.includes("Menu")) ||
              ...
              if (message.text.body) {
                ...
                if (strippedBody.length === 11) {
                  ...
                  if (/^\d+$/.test(strippedBody)) {
                    console.log(
                      "A mensagem contém apenas números e tem 11 caracteres:",
                      strippedBody
                    );
                          ...
                          axios({
                            ...
                            data: {
                              ...
                              text: {
                                preview_url: true,
                                body:
                                  "Você possui um boleto registrado que está disponível no link abaixo: \n\nhttps://boleto.clubefiladelfia.com.br/api/public/b?idt=jJTBjJpx3spukhKDLM8jJCCoSONs4Wex" +
                                  response.data +
                                  "&m=" +
                                  mes_atual +
